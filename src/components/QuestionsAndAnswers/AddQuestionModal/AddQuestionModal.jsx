  ...
  return (
    <div className="QandA-modal-body">
      ...
      <form id="submit-question-form" className="QandA-modal-form">
        <label className="QandA-modal-label" htmlFor="your-question">
          YOUR QUESTION*:
        </label>
        <br></br>
        <textarea
        ...
        ></textarea>
        <br></br>
        <label className="QandA-modal-label" htmlFor="question-nickname">
        ...
        <br></br>
        <label className="QandA-modal-label" htmlFor="question-email">
          YOUR E-MAIL*:
        </label>
        <br></br>
        <input
