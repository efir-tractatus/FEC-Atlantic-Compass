    ...
    <div className="question-list-entry">
      <div className="Q-grid-container">
        ...
        <div className="question-utility-container Q-col-3">
          ...
          <InteractionTracker
            widget="QandA"
            element="Mark-question-helpful"
            render={({ postInteraction }) => (
              <a
                className="question-utility-link"
                onClick={(e) => {
                  if (!isMarkedHelpful) {
...
var postHelpfulness = (questionId, productId, populateQuestions) => {
  axios
    .put(`/catwalk/qa/questions/helpful/${questionId}`)
    .then((response) => {
...
var postReported = (questionId, productId, populateQuestions) => {
  axios
    .put(`/catwalk/qa/questions/report/${questionId}`)
    .then((response) => {
      console.log('success', response);
    })
    .catch((err) => {
