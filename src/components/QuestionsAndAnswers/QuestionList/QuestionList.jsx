...
var QuestionList = (props) => {
  ...
  if (isLoading === true) {
    return <div className="question-list-default">LOADING QUESTIONS...</div>;
  }
  ...
  if (availableQuestions.length <= 0) {
    return (
      <div className="question-list">
        <InteractionTracker
          widget="QandA"
          element="Add-a-question"
          render={({ postInteraction }) => (
            <button
              className="QandA-button-add-question"
              onClick={() => {
                postInteraction();
                setIsOpen(true);
              }}
    ...
    return (
      <div className="question-list">
        ...
        <div className="button-flex-container">
          <InteractionTracker
            widget="QandA"
            element="Load-more-questions"
            render={({ postInteraction }) => (
              <a href="#QandA-widget">
                <button
                  className="QandA-button-more-questions"
                  href="#QandA-widget"
                  onClick={() => {
                    postInteraction();
