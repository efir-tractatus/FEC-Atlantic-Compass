  ...
  return axios
    ...
    .then(
      axios.spread(
        (
          primaryProduct,
          primaryProductStyles,
          primaryProductQuestions,
          primaryProductReviews,
          primaryProductReviewsNumbers
        ) => {
          results = {
...
app.post('/catwalk/interactions', (req, res) => {
  ...
  return axios
    .post(`${APIURL}/interactions`, req.body)
    .then((response) => {
...
app.get('/catwalk/qa/questions/:id', (req, res) => {
  ...
  var id = req.params.id;
  axios
    .get(`${APIURL}/qa/questions/?product_id=${id}&count=50`)
    .then((response) => {
...
app.post('/catwalk/qa/questions', (req, res) => {
  console.log(req.body);
  axios
    .post(`${APIURL}/qa/questions`, req.body)
    .then((response) => {
...
app.put('/catwalk/qa/questions/helpful/:id', (req, res) => {
  ...
  return axios
    .put(`${APIURL}/qa/questions/${questionId}/helpful`)
    .then((response) => {
...
app.put('/catwalk/qa/questions/report/:id', (req, res) => {
  ...
  var questionId = req.params.id;
  return axios
    .put(`${APIURL}/qa/questions/${questionId}/report`)
    .then((response) => {
...
app.post('/catwalk/qa/answers/:id', (req, res) => {
  ...
  console.log(req.body);
  return axios
    .post(`${APIURL}/qa/questions/${questionId}/answers`, req.body)
    .then((response) => {
...
app.put('/catwalk/qa/answers/helpful/:id', (req, res) => {
  ...
  return axios
    .put(`${APIURL}/qa/answers/${answerId}/helpful`)
    .then((response) => {
...
app.put('/catwalk/qa/answers/report/:id', (req, res) => {
  ...
  var answerId = req.params.id;
  return axios
    .put(`${APIURL}/qa/answers/${answerId}/report`)
    .then((response) => {
